...

{
  ...
  frame '{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///tmp/koshkit-only.sh","languageId":"sh","version":1,"text":"calc 1 + 1\n"}}}'
  frame '{"jsonrpc":"2.0","id":112,"method":"textDocument/hover","params":{"textDocument":{"uri":"file:///tmp/koshkit-only.sh"},"position":{"line":0,"character":1}}}'

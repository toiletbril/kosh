...

{
  ...
  frame '{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///tmp/koshkit-only.shit","languageId":"shit","version":1,"text":"goodnode /tmp\n"}}}'
  ...
  frame '{"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///tmp/koshkit-posix.sh","languageId":"sh","version":1,"text":"goodnode /tmp\n"}}}'
...
check_contains utility-help '"id":112,"result":{"contents":{"kind":"plaintext","value":"DESCRIPTION\n  The goodnode utility'
check_contains posix-mood-utility-help '"id":120,"result":{"contents":{"kind":"plaintext","value":"DESCRIPTION\n  The goodnode utility'

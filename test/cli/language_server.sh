...

{
  ...
  frame '{"jsonrpc":"2.0","id":103,"method":"textDocument/hover","params":{"textDocument":{"uri":"file:///tmp/shell-variable.sh"},"position":{"line":1,"character":72}}}'

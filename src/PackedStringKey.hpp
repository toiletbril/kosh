 ...
 *
 * This file implements fixed-size packed keys for hot string tables. It
 * packs literals and views, then provides fast comparison, length,
 * leading-byte, and string conversion operations.
 */

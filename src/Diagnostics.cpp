...
const diagnostic_definition DIAGNOSTIC_DEFINITIONS[] = {
    ...
    D(0, "optimizer-eliminated-cstyle-for",
      ...
      "Remove the loop or write a condition that can be true", None, Strict,
      Warning),
    D(0, "optimizer-eliminated-for",
      ...
      "Remove the loop or give it words to iterate over", None, Strict,
      Warning),
    D(0, "optimizer-eliminated-if", "an if with no reachable body was removed",
      ...
      "body",
      "Remove the `if` or write a condition that can be true", None, Strict,
      Warning),
    ...
    D(0, "optimizer-folded-loop", "a loop condition is statically false",
      "This `{0}` loop condition never lets the body run", None, None, Strict,
      Warning),
